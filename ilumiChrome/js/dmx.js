...
var pulpito = {
  ...
  "setBrightness": function(value) { dmx.setBrightnessAllChannels(dmx_map.pulpito, value); }
}
...
var pernas = {
  "acende": function() { dmx.setBrightnessAllChannels(dmx_map.lateral, 255); },
  "apaga": function() { dmx.setBrightnessAllChannels(dmx_map.lateral, 0); }
}

var logo = {
  "acende": function() { dmx.setBrightnessAllChannels(dmx_map.logo, 255); },
  "apaga": function() { dmx.setBrightnessAllChannels(dmx_map.logo, 0); },
  "setBrightness": function(value) { dmx.setBrightnessAllChannels(dmx_map.logo, value); }
}
...
var dmx_map = {
  ...
  "geral": {
    "dimmer": 131, //TODO: mudar para 131 em producao
    "red": 128,
    "green": 129,
    "blue": 130
  },
